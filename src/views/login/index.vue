...
export default {
  ...
  mounted() {
    main()
    this.init()
    this.browserRedirect()// 调用判断当前访问页面是手机端还是移动端
  },
  methods: {
    init() {
    ...
    browserRedirect() {
      ...
      // console.log('型号', bIsIpad, bIsIphoneOs, bIsMidp, bIsUc7, bIsUc, bIsAndroid, bIsCE, bIsWM)
      // if (bIsIpad || bIsIphoneOs || bIsMidp || bIsUc7 || bIsUc || bIsAndroid || bIsCE || bIsWM) {
      //   window.location.href = 'https://app.dxer168.com/cz/index.html'
      // } else {
      //   console.log('电脑登陆')
      // }
    },
    ...
    handleLogin() {
      this.$refs.loginForm.validate(valid => {
        if (valid && this.divDisable) {
          console.log('valid', valid, this.divDisable)
          this.loading = true
          ...
          console.log('error submit!!', valid, this.divDisable)
          return false
        }
      })
    }
