    ...
    <div class="login" style="width:450px;margin-left:-225px;height:700px;margin-top:-350px;">
      ...
      >
        ...
        <el-form-item class="login-center clearfix" prop="captchaCode">
          ...
          <div class="login-center-input">
            <input id="imgvcode" v-model="captchaCode" type="text" class="validate" placeholder="请输入验证码" onfocus="this.placeholder=''" onblur="this.placeholder='请输入验证码'">
        ...
        <el-form-item class="login-center clearfix" prop="vcode">
          <div class="login-center-img"><svg-icon icon-class="password" style="color: #889aa4" /></div>
          <div class="login-center-input">
            <input v-model="form.vcode" type="text" class="validate" placeholder="请输入短信验证码" onfocus="this.placeholder=''" onblur="this.placeholder='请输入短信验证码'">
        ...
        <el-form-item class="login-center clearfix" prop="password">
          <div class="login-center-img"><svg-icon icon-class="password" style="color: #889aa4" /></div>
          <div class="login-center-input">
            <input v-model="form.password" type="password" value="" placeholder="请输入您的新密码" onfocus="this.placeholder=''" onblur="this.placeholder='请输入您的新密码'">
        ...
        <el-form-item class="login-center clearfix" prop="passwordConfirm">
          <div class="login-center-img"><svg-icon icon-class="password" style="color: #889aa4" /></div>
          <div class="login-center-input">
            <input v-model="form.passwordConfirm" type="password" value="" placeholder="请确认您的密码" onfocus="this.placeholder=''" onblur="this.placeholder='请确认您的密码'">
