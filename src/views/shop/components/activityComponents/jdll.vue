<template>
  <div class="form" style="position:relative;">
    ...
    <div v-for="item in addShop" :key="item.id">
    ...
    <div class="form-item">
      ...
      <div class="form-block radio-list">
        <el-radio-group
          ...
          text-color="#6666FF"
        >
          <el-radio v-for="item in sortList" :key="item.id" :label="item.name">{{ item.name }}</el-radio>
        </el-radio-group>
      </div>
    </div>
    ...
    <div v-for="item in addKeyWord" :key="item.id" v-if="form.searchType===1" class="form-item">
      <span class="form-required">*必填</span>
    ...
    <div v-for="item in addewm" :key="item.id" v-if="form.searchType===3" class="form-item" style="position: relative">
      <span class="form-required">*必填</span>
    ...
    <div v-for="item in orderout" :key="item.id" class="form-item">
      <span class="form-label" style="margin:0 5px 0 45px;">
        任务发布时间
      </span>
      <el-date-picker
    ...
    <div class="form-item">
      ...
      <el-checkbox-group v-model="form.taskAdditionalIncrement.goodsCategory">
        <div style="width: 550px;">
          <el-checkbox v-for="item in goodsCategoryList" :key="item.id" :label="item.id">{{ item.name }}</el-checkbox>
        </div>
      </el-checkbox-group>
    </div>
    <div class="form-item">
