<template>
  <div style="position:relative;">
    <div style="margin-bottom: 20px">
      ...
      <el-button size="mini" class="btn-theme" style="float: right;" @click="dialogFormVisible=true">申诉</el-button>
      <!-- <el-button size="mini" class="btn-theme" style="float: right;padding: 3px 12px;" @click="dialogFormVisible=true">申诉</el-button> -->
      <el-button size="mini" class="btn-theme" style="float: right;margin-right:20px;" @click="handlerouter">返回</el-button>
      <!-- <el-button size="mini" class="btn-theme" style="float: right;padding: 3px 12px;" @click="historyNotGo">返回</el-button> -->
...
export default {
  ...
  methods: {
    ...
    handlerouter() {
      ...
      this.$router.push({ path: '/admin/shop/order' })
      console.log('跳')
    },
    // 点击返回
    historyNotGo() {
      ...
      // }
      // this.$router.push({ path: '/admin/shop/order', query: param })
      // history.back()
    },
    // 展示大图
    toBigImg(data) {
