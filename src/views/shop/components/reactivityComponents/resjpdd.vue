...
export default {
  ...
  methods: {
    ...
    handleNext() {
      ...
      if (this.form.taskGoodsList[0].url.indexOf('http') === -1) {
      ...
      if (this.form.taskGoodsList.length > 1) {
        if (this.form.taskGoodsList[1].url.indexOf('http') === -1) {
          this.form.taskGoodsList[1].url = ''
        }
        if (this.form.taskGoodsList.length === 3) {
          if (this.form.taskGoodsList[2].url.indexOf('http') === -1) {
      ...
      // if (this.changeTimeData === true) {
      //   var taskReleaseTimeData = this.form.taskReleaseTime
      //   var taskReleaseTimeData1 = null
      //   var taskReleaseTimeData2 = null
      //   taskReleaseTimeData = taskReleaseTimeData.split('-')
      //   taskReleaseTimeData1 = `${taskReleaseTimeData[0]}-${taskReleaseTimeData[1]}-${taskReleaseTimeData[2]} ${taskReleaseTimeData[3]}:${taskReleaseTimeData[4]}:${taskReleaseTimeData[5]}`
      //   taskReleaseTimeData2 = `${taskReleaseTimeData[0]}-${taskReleaseTimeData[1]}-${taskReleaseTimeData[2]}`
      //   // data.taskReleaseTime = JSON.stringify(this.form.taskReleaseTime)
      //   data.taskReleaseTimeList = taskReleaseTimeData1
      //   data.taskReleaseTime = taskReleaseTimeData1
      //   data.releaseDate = taskReleaseTimeData2
      //   var myDate1 = new Date()
      //   var md = myDate1.getDate()
      //   var mh = myDate1.getHours()
      //   var mm = myDate1.getMinutes()
      //   // var ms = myDate1.getSeconds()
      //   var date2 = Number(taskReleaseTimeData[2])
      //   var date3 = Number(taskReleaseTimeData[3])
      //   var date4 = Number(taskReleaseTimeData[4]) + 5
      //   if (date2 === md) {
      //     if (date3 === mh) {
      //       if (date4 < mm) {
      //         this.$message({
      //           message: '任务发布时间不能为过去时间',
      //           type: 'warning'
      //         })
      //       } else {
      //         create(data).then(response => {
      ...
      //   var m1 = nowdate.getMinutes()
      //   var s = nowdate.getSeconds()
      //   var tt = y + '-' + m + '-' + d
      //   var tt1 = y + '-' + m + '-' + d + ' ' + h + ':' + m1 + ':' + s
      //   data.releaseDate = tt
      //   data.taskReleaseTime = tt1
      //   create(data).then(response => {
      //     if (response.code === 0) {
      //       this.handlePrice(response.data)
      //       numId = response.data
