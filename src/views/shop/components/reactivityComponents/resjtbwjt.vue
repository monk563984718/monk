...
export default {
  ...
  methods: {
    ...
    handleGuanjc() {
      console.log('新增数据看一下什么样子', this.form.taskCommentList)
    ...
    handleNext() {
      ...
      // console.log('整个otherKey123', otherKey, this.wzList)
      if (this.form.searchType === 1) {
        num = this.order1
      } else if (this.form.searchType === 2) {
        num = this.order2
      ...
      // console.log('整个的数据', this.form)
      // console.log('整个taskCommentList的数据', data.taskCommentList)
      // console.log('整个otherKey', otherKey)
      // console.log('整个的数据', this.form)
      // console.log('整个taskCommentList的数据', data.taskCommentList)
    ...
    stitchingData(keyword, otherKey, num) {
      console.log('asdas', keyword, otherKey, num)
      var data = []
      var otherkeyItem = 0
