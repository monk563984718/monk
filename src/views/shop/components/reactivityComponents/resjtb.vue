  ...
  <div class="form" style="position:relative;">
    ...
    <!-- <div class="form-item">
      ...
      <el-date-picker
        ...
        @change="changeTime"
      />
      <div class="form-label" style="margin:0 20px;">
        每隔
        <el-input v-model="form.interval" size="mini" style="width: 140px" type="number">
          <template slot="append">分钟</template>
        </el-input>
        放出1单
      </div>
      <div class="form-label" style="margin-left:35px;">
        <span style="width:600px;" />
        <span style="color: #97A8BE;width: 100px;text-align: center">共放</span>
        <span style="margin-left:5px;">{{ inputAll }}</span>
      </div>
    </div> -->
...
export default {
  ...
  methods: {
    ...
    creatData() {
      ...
      // if (goodsdatas.postData.taskReleaseTimeList[0].releaseTime) {
      //   var releaseTimeDataList = goodsdatas.postData.taskReleaseTimeList[0].releaseTime.split(' ')
      //   var releaseTimeDataList1 = releaseTimeDataList[1].split(':')
      //   this.form.taskReleaseTime = `${releaseTimeDataList[0]}-${releaseTimeDataList1[0]}-${releaseTimeDataList1[1]}-${releaseTimeDataList1[2]}`
      // }
      // taskReleaseTimeList: [{ taskReleaseTime: null, interval: 0, orderNum: 1 }], // 定义发布任务时间变量
      // orderout: 1, // 定时发布单量
      console.log('goodsdatas.postData.taskReleaseTimeList', goodsdatas.postData.taskReleaseTimeList)
      ...
      // this.form.taskReleaseTime = goodsdatas.postData.taskReleaseTimeList[0].releaseTime
      // this.form.interval = goodsdatas.postData.taskReleaseTimeList[0].intervalTime
      // for(var tt = 0; tt< goodsdatas.postData.taskReleaseTimeList.length;tt++){
