  ...
  <div>
    ...
    <div v-if="activeName=='gift'">
      <div class="context">
        ...
        <p class="p">3、商家如果发布了多多进宝AB单活动选择了平台代发，两次选择的礼品务必一致。否则因商家原因导致用户退款、投诉等情况，平台概不负责。</p>
      ...
      <div class="form">
        <div class="form-item">
          ...
          <span class="udllink exampleImg" @click="previewPrice=true">快递价格表</span>
        </div>
        <ul class="goods-list">
        ...
        <div class="form-item">
          ...
          <div class="form-err">（商家务必备注不能接受的快递）</div>
        </div>
        <div class="form-item">
          <span class="form-required">*必填</span>
          ...
          <div class="form-block">
            <div style="display: flex;position: relative">
              <!-- <input v-model="giftListName" type="text" class="form-input w100"> -->
              <el-upload
                ref="upload"
                action=""
                :auto-upload="false"
          ...
          <div class="form-block">
            <table class="table">
              ...
              <tr>
                ...
                <td>{{ orderDetail.expressAmount }}</td>
        ...
        <div class="form-item">
          ...
          <div class="form-block">
            ...
            <!-- <button class="btn downBtn">
              <a :href="hrefaddlis + hrefaddlist1" style="color: #6666FF">
                下载模版
              </a>
            </button> -->
          </div>
...
<script>
const previewUrl = require('@/assets/images/lipin1.png')
// const hrefadd = 'http://193.112.147.210:82/api/business/downExcl?type=1'
// const hrefadd1 = 'http://193.112.147.210:82/api/business/downExcl?type=2'
const hrefadd = 'https://web.dxer168.com/api/business/downExcl?type=1'
const hrefadd1 = 'https://web.dxer168.com/api/business/downExcl?type=2'
// const hrefadd = 'http://192.168.1.9:82/api/business/downExcl?type=1'
// const hrefadd1 = 'http://192.168.1.9:82/api/business/downExcl?type=2'
...
export default {
  ...
  methods: {
    ...
    handleAddYwGiftOrder() {
      // this.handleExcelUp()
      this.orderDetail.amountMoney = Number(this.orderDetail.amountMoney)
      this.orderDetail.balance = Number(this.orderDetail.balance)
      if (this.orderDetail.amountMoney <= this.orderDetail.balance) {
        const data = {
    ...
    httpRequest(file) {
      ...
      this.giftListName = file.file.name
    },
    // handleExcelUp() {
    ...
    //         duration: 2000
    //       })
    //       console.log('ceshi 核对订单的数据', response.data)
    ...
    //   console.log('asdas')
    //   // this.$refs.upload.submit()
    //   console.log('id和文件', this.giftForm.gId, this.giftForm.file)
    //   if (this.giftForm.gId || this.giftForm.file) {
    //     const gift = {
    //       gId: this.giftForm.gId
    //     }
    //     const file = new FormData() // 创建form对象
    //     file.append('file', this.giftForm.file)
    //     console.log('文件数据', gift, file)
    //     upGiftExcel(gift, file).then(response => {
    //       if (response.code === 0) {
    //         this.$message({
    //           message: '提交成功',
    ...
    handleAddEmptyOrder() {
      if (this.emptyOrderDetail.amountMoney <= this.emptyOrderDetail.balance) {
        const data = {
          cId: this.emptyForm.cId,
