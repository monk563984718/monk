          ...
          <div class="form-block radio-list radio-list-y" @click="clickStoreRebate">
            <el-radio-group v-model="refundFlag">
              <div class="item">
                <div class="item-img" />
                <div class="checkbox">
                  <el-radio v-model="refundFlag" :label="1" disabled>
                    平台返款
                  </el-radio>
                  <span class="radio-tip">(平台代替商家返款给用户, 返款服务费<span style="color:#ff5757;">&nbsp;+1元/单</span>)</span>
                  <!-- <span class="radio-tip">(平台代替商家返款给用户,返款服务费 <span>{{}}</span>)</span> -->
                </div>
              </div>
              <div class="item">
                <div class="item-img" />
                <div class="checkbox">
                  ...
                  <span class="radio-tip">(商家自行返款给用户)</span>
                </div>
              </div>
