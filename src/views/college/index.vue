...
<script>
    ...
    export default {
        ...
        methods:{
            init(){
              var localData = sessionStorage.getItem('college')
              if(localData !== null){
                localData = JSON.parse(localData)
                // var localData = sessionStorage.getItem('college')
                this.listQuery = localData
              }
            ...
            handleCurrentChange(){
              var collegeSmith = JSON.stringify(this.listQuery)
              sessionStorage.setItem('college', collegeSmith)
                this.init()
            },
            handleSizeChange(){
            },
